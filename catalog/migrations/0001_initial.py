    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Enter summary of the book', max_length=1000, null=True)),
                ('isbn', models.CharField(help_text='<a href="https://www.isbn-international.org/content/what-isbn">Enter ISBN of the book</a>', max_length=20, unique=True, verbose_name='ISBN')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter genre', max_length=100, unique=True)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(blank=True, help_text='Select genre', to='catalog.genre'),
        ),
    ]
